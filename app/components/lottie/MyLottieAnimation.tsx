...
export const MyLottieAnimation = ({
	...
	const usedLoop = loop === undefined ? true : loop; // Accessibility tells that animations should only play onces. for abother play the user should trigger it by touching it again.
